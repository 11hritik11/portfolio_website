...
export default function MangaPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-manga-white dark:bg-ink-black border-b-4 border-ink-black dark:border-[oklch(0.75_0.14_85)]">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-primary rounded-full border-4 border-ink-black dark:border-[oklch(0.75_0.14_85)] flex items-center justify-center font-bold text-primary-foreground text-xl">
                H
              </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <button
                ...
                className="p-2 rounded-md hover:bg-primary hover:text-primary-foreground transition-colors border-2 border-ink-black dark:border-[oklch(0.75_0.14_85)]"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 manga-card bg-manga-white dark:bg-card p-8 lg:p-12 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-primary text-primary-foreground px-4 py-2 rotate-3 font-black text-sm border-3 border-ink-black shadow-lg">
                PRESIDENTIAL SCHOLAR!
              </div>
              <div className="relative z-10">
                <div className="inline-block bg-secondary text-secondary-foreground px-3 py-1 text-xs font-bold uppercase mb-4 border-2 border-ink-black dark:border-manga-white">
                  STUDENT & RESEARCHER
                </div>
                <h1 className="text-5xl lg:text-7xl font-black mb-4 burst-title uppercase leading-tight">
                  RASTRABHUSHAN
                  <br />
                  <span className="text-primary">DAHAL</span>
                </h1>
                ...
                <p className="text-lg mb-8 leading-relaxed">
                  ...
                  <span className="font-bold text-primary">Texas State University</span>. Specializing in Machine
                ...
                <div className="flex flex-wrap gap-3">
                  <Button
                    asChild
                    size="lg"
                    className="font-black uppercase bg-primary hover:bg-primary/90 text-primary-foreground border-3 border-ink-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)] transition-all"
                  >
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="font-black uppercase border-3 border-ink-black dark:border-[oklch(0.75_0.14_85)] shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(180,130,70,0.3)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)] transition-all bg-transparent"
                  >
              ...
              <div className="absolute bottom-8 right-8 hidden lg:block">
                <div className="relative bg-manga-white dark:bg-card border-3 border-ink-black dark:border-[oklch(0.75_0.14_85)] rounded-2xl p-4 shadow-lg">
                  <div className="absolute -bottom-3 right-8 w-0 h-0 border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent border-t-[15px] border-t-ink-black dark:border-t-[oklch(0.75_0.14_85)]" />
            ...
            <div className="space-y-6">
              <div className="manga-card bg-secondary text-secondary-foreground p-6 relative overflow-hidden h-full min-h-[300px] flex flex-col justify-between">
                <div>
                  <div className="font-black text-2xl mb-2 uppercase">ROYAL NINJA!</div>
                  <p className="text-sm opacity-90 mb-4">
                    Never give up on your projects, believe in your code, and always push forward!
                  </p>
                </div>
                {/* Placeholder for Naruto character */}
                <div className="relative w-full h-48 bg-primary/20 border-3 border-primary-foreground rounded-lg overflow-hidden">
              ...
              <div className="manga-card bg-card p-6 mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg border-2 border-border">
                    ...
                    <div>
                      <div className="font-bold uppercase text-sm text-primary mb-1">RiverHacks Winner</div>
                      <p className="text-sm">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg border-2 border-border">
                    ...
                    <div>
                      <div className="font-bold uppercase text-sm text-secondary mb-1">EEG Research Published</div>
                      <p className="text-sm">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-lg border-2 border-border">
                    <div className="w-2 h-2 bg-[oklch(0.72_0.14_85)] rounded-full mt-2" />
                    <div>
                      <div className="font-bold uppercase text-sm text-[oklch(0.72_0.14_85)] mb-1">
              ...
              <div className="manga-card bg-card p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl font-black text-primary">GENIUS</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold">GPA</span>
                    <span className="text-xl font-black text-secondary">4.0</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold">PROJECTS</span>
                    <span className="text-xl font-black text-[oklch(0.72_0.14_85)]">4+</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold">HACKATHONS</span>
                    <span className="text-xl font-black text-secondary">WON 1</span>
                  </div>
                </div>
              </div>

              <div className="manga-card bg-primary text-primary-foreground p-6 text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-black uppercase mb-4">
              <span className="text-primary">COMPLETED</span> MISSIONS
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="manga-card bg-card p-0 overflow-hidden action-effect group">
              <div className="relative h-48 bg-gradient-to-br from-primary to-secondary overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-primary text-primary-foreground px-3 py-1 text-xs font-black uppercase border-2 border-ink-black rotate-3">
                  WINNER
                </div>
              </div>
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge className="comic-badge bg-primary/10 text-primary border-primary">
                    PYTHON
                  </Badge>
                  <Badge className="comic-badge bg-secondary/10 text-secondary border-secondary">XGBOOST</Badge>
            ...
            {/* Project 2 - Adaptly */}
            <div className="manga-card bg-card p-0 overflow-hidden action-effect group">
              <div className="relative h-48 bg-gradient-to-br from-secondary to-[oklch(0.72_0.14_85)] overflow-hidden">
                <img
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className="comic-badge bg-secondary/10 text-secondary border-secondary">PANDAS</Badge>
            ...
            {/* Project 3 - CaliHome */}
            <div className="manga-card bg-card p-0 overflow-hidden action-effect group">
              <div className="relative h-48 bg-gradient-to-br from-[oklch(0.72_0.14_85)] to-secondary overflow-hidden">
                <img
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className="comic-badge bg-secondary/10 text-secondary border-secondary">SCIKIT-LEARN</Badge>
            ...
            <div className="manga-card bg-card p-0 overflow-hidden action-effect group">
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className="comic-badge bg-secondary/10 text-secondary border-secondary">MNE</Badge>
                  <Badge className="comic-badge bg-muted text-foreground border-border">STREAMLIT</Badge>
                </div>
              </div>
            </div>
      ...
      <section id="skills" className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-black uppercase mb-4">
              MY <span className="text-primary">JUTSU</span> ARSENAL
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="manga-card bg-card p-6 chakra-glow">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-primary rounded-full border-3 border-ink-black dark:border-manga-white flex items-center justify-center">
            ...
            <div className="manga-card bg-card p-6 chakra-glow">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-secondary rounded-full border-3 border-ink-black dark:border-manga-white flex items-center justify-center">
            ...
            <div className="manga-card bg-card p-6 chakra-glow">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-[oklch(0.72_0.14_85)] rounded-full border-3 border-ink-black dark:border-manga-white flex items-center justify-center">
                  <Zap className="w-6 h-6 text-[oklch(0.12_0.03_300)]" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div>
              <h2 className="text-4xl font-black uppercase mb-6">
                MY <span className="text-primary">NINJA WAY</span>
              </h2>
              ...
              <div className="manga-card bg-card p-6">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    <span className="font-bold text-primary">🔬 Research:</span> Working on large-scale EEG
                    datasets, focusing on sleep-related neural signals
                  </p>
                  <p>
                    <span className="font-bold text-secondary">💻 Development:</span> Building Python-based pipelines
                    for signal processing and ML analysis
                  </p>
                  <p>
                    <span className="font-bold text-[oklch(0.72_0.14_85)]">🎯 Goal:</span> Investigating relationships between
            ...
            <div className="space-y-6">
              {/* Education panel */}
              <div className="manga-card bg-card p-6">
                <h3 className="font-black uppercase text-xl mb-4 border-b-3 border-primary pb-2">EDUCATION</h3>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-sm">
                      ...
                      <p className="font-bold text-primary">GPA: 4.0</p>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge className="comic-badge bg-secondary/10 text-secondary border-secondary">2024</Badge>
                    </div>
              ...
              <div className="manga-card bg-gradient-to-br from-primary via-secondary to-[oklch(0.72_0.14_85)] p-1">
      ...
      <section id="contact" className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="manga-card bg-card p-12 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-secondary to-[oklch(0.72_0.14_85)]" />
            <h2 className="text-4xl lg:text-5xl font-black uppercase mb-4">
              LET'S <span className="text-primary">TEAM UP!</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-8">
              <Button
                asChild
                size="lg"
                className="font-black uppercase bg-primary hover:bg-primary/90 text-primary-foreground border-3 border-ink-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)] transition-all"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="font-black uppercase border-3 border-ink-black dark:border-[oklch(0.75_0.14_85)] shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)] transition-all bg-transparent"
              >
            ...
            <div className="flex gap-6 justify-center text-muted-foreground">
              ...
              <a href="mailto:rdb200@txstate.edu" className="hover:text-primary transition-colors">
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t-4 border-ink-black dark:border-[oklch(0.75_0.14_85)] bg-muted/30">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-bold uppercase text-sm">
            © 2025 Rastrabhushan Dahal • Built with <span className="text-primary">❤️</span> and lots of ramen
          </p>
